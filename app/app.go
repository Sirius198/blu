...
type App struct {
	*baseapp.BaseApp
	...
	BluKeeper blumodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.BluKeeper = *blumodulekeeper.NewKeeper(
		appCodec,
		keys[blumoduletypes.StoreKey],
		keys[blumoduletypes.MemStoreKey],
		app.GetSubspace(blumoduletypes.ModuleName),
	)
	bluModule := blumodule.NewAppModule(appCodec, app.BluKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(blumoduletypes.ModuleName)
